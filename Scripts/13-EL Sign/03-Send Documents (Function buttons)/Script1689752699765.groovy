...
WebUI.click(findTestObject('13-EL Sign/span_Status'))

WebUI.click(findTestObject('13-EL Sign/span_Signer Status'))
...
WebUI.click(findTestObject('13-EL Sign/span_History'))

WebUI.click(findTestObject('13-EL Sign/span_Reminder'))
