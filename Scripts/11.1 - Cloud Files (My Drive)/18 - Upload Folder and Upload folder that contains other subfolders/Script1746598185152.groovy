...
WebUI.doubleClick(findTestObject('11-Cloud Files/span_automationFolder'))
...
WebUI.waitForElementPresent(findTestObject('11-Cloud Files/span_subFolder'), 0)

WebUI.verifyElementVisible(findTestObject('11-Cloud Files/span_subFolder'))

WebUI.delay(GlobalVariable.delay_2s)

WebUI.click(findTestObject('11-Cloud Files/right_arrow2'))

WebUI.waitForElementPresent(findTestObject('11-Cloud Files/span_New Folder'), 0)

WebUI.verifyElementVisible(findTestObject('11-Cloud Files/span_New Folder'))
