...
WebUI.setText(findTestObject('00-Signup and Activation/input_Email'), 'autotester20@mailinator.com')
...
WebUI.setText(findTestObject('00-Signup and Activation/zMailinator/input_LOGIN_search'), 'autotester20@mailinator.com')
