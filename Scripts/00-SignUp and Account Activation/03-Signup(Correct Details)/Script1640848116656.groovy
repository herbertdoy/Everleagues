...
WebUI.setText(findTestObject('00-Signup and Activation/input_Email'), 'autotester81@mailinator.com')
...
WebUI.setText(findTestObject('00-Signup and Activation/zMailinator/input_LOGIN_search'), 'autotester81@mailinator.com')
