...
WebUI.setEncryptedText(findTestObject('Object Repository/01-Login/input_Email_password'), 'OxgQgnWTiECE3BxjMAl2ng==')
...
WebUI.verifyElementPresent(findTestObject('01-Login/Invalid user name or password'), 0)
