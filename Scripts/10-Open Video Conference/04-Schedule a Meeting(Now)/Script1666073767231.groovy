...
WebUI.click(findTestObject('10-Open Video Conference/span_GG Client (autotester09mailinator.com)'))
...
WebUI.click(findTestObject('10-Open Video Conference/span_GG Partner (autotester10mailinator.com)'))

WebUI.click(findTestObject('10-Open Video Conference/span_GG tester (autotester04mailinator.com)'))

WebUI.click(findTestObject('10-Open Video Conference/span_GG tester 2 (autotester01mailinator.com)'))

WebUI.click(findTestObject('10-Open Video Conference/span_GG Tester 3 (autotester03mailinator.com)'))
