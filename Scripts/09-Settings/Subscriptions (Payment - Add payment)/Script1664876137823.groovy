...
WebUI.verifyElementVisible(findTestObject('09-Settings/Subscription/div_Payment'))

WebUI.click(findTestObject('09-Settings/Subscription/div_Payment'))

WebUI.delay(3)

WebUI.click(findTestObject('09-Settings/Subscription/Payment/button_add payment'))

WebUI.verifyElementVisible(findTestObject('09-Settings/Subscription/Payment/mat-dialog-container_Add Card modal'))

WebUI.verifyElementVisible(findTestObject('09-Settings/Subscription/Payment/h4_Add Card'))
...
WebUI.click(findTestObject('09-Settings/Subscription/Payment/input_cardnumber'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('09-Settings/Subscription/Payment/input_exp-date'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('09-Settings/Subscription/Payment/input_cvc'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('09-Settings/Subscription/General/input_Name on Card field'), 'GG Card2')

WebUI.setText(findTestObject('09-Settings/Subscription/Payment/input_cardnumber'), '4242424242424242')

WebUI.setText(findTestObject('09-Settings/Subscription/Payment/input_exp-date'), '1223')

WebUI.setText(findTestObject('09-Settings/Subscription/Payment/input_cvc'), '123')

'change everytime when you upgrade'
WebUI.setText(findTestObject('09-Settings/Subscription/General/input_Zip-Postal Code field'), '60488')

WebUI.delay(3)

WebUI.click(findTestObject('09-Settings/Subscription/Payment/button_Add Card'), FailureHandling.STOP_ON_FAILURE)
