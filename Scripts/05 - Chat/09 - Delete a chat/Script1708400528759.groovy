...
WebUI.verifyElementVisible(findTestObject('05-Chat/Delete a message/mat-dialog-container_Delete message'))

WebUI.delay(GlobalVariable.delay_2s)

WebUI.click(findTestObject('05-Chat/Delete a message/button_Delete'))
