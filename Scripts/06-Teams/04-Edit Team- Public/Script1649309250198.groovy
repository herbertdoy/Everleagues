...
WebUI.click(findTestObject('06-Teams/03-Edit Team - Private/button_delete channel'))

WebUI.verifyElementVisible(findTestObject('06-Teams/03-Edit Team - Private/Delete confirm modal'))
