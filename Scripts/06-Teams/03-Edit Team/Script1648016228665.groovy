...
WebUI.click(findTestObject('06-Teams/03-Edit Team/button_edit Auto Team Private'))

WebUI.delay(3)

WebUI.verifyElementVisible(findTestObject('06-Teams/03-Edit Team/h4_Edit Auto Team Private'))

WebUI.verifyElementVisible(findTestObject('06-Teams/03-Edit Team/div_Members'))

WebUI.verifyElementVisible(findTestObject('06-Teams/03-Edit Team/div_Channels'))

WebUI.verifyElementVisible(findTestObject('06-Teams/03-Edit Team/div_Settings'))
