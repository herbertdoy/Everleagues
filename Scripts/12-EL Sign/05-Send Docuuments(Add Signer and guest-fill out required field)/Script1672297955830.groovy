...
WebUI.click(findTestObject('12-EL Sign/mat-option_GG TESTER (testuser02mailinator.com)'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('12-EL Sign/mat-option_norvs26mailinator.com'))

WebUI.scrollToElement(findTestObject('12-EL Sign/button_SAVE2'), 0)

WebUI.click(findTestObject('12-EL Sign/button_SAVE2'))
