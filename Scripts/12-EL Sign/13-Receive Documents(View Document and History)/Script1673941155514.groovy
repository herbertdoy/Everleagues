...
WebUI.click(findTestObject('12-EL Sign/button_visibility'))
...
WebUI.verifyElementVisible(findTestObject('12-EL Sign/div_statusSigned'))

WebUI.click(findTestObject('12-EL Sign/button_history'))

WebUI.verifyElementVisible(findTestObject('12-EL Sign/mat-dialog-container-historyModal'))
