...
WebUI.click(findTestObject('12-EL Sign/input_documentTitle'))

WebUI.sendKeys(findTestObject('Object Repository/12-EL Sign/input_documentTitle'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Object Repository/12-EL Sign/input_documentTitle'), Keys.chord(Keys.BACK_SPACE))

WebUI.clickOffset(findTestObject('12-EL Sign/h4_ELSign'), 100, 100)

WebUI.verifyElementVisible(findTestObject('12-EL Sign/mat-error_Title is required'))
