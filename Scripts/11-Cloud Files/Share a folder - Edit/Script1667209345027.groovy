...
WebUI.verifyElementVisible(findTestObject('11-Cloud Files/span_GG tester 2'))
...
WebUI.verifyElementVisible(findTestObject('11-Cloud Files/span_GG Tester 3'))

WebUI.click(findTestObject('11-Cloud Files/div_dropdown4'))
